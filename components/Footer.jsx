...
const Footer = () => {
    ...
    const TikTokIcon = () => (<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M15.8333 2.5H12.5V10.8333C12.5 11.5667 11.9167 12.1667 11.1667 12.1667C10.4167 12.1667 9.83333 11.5833 9.83333 10.8333V2.5H6.5V10.8333C6.5 13.6 8.66667 15.8333 11.1667 15.8333C13.6667 15.8333 15.8333 13.6667 15.8333 11.1667V6.66667C17.0833 7.5 18.6667 8.08333 20 8.08333V5C18.3333 5 16.8333 4.16667 15.8333 2.5Z" stroke="#90A1B9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /> </svg>)
    ...
    const linkSections = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Power Banks", path: '/', icon: null },
                { text: "Chargers", path: '/', icon: null },
                { text: "Cables", path: '/', icon: null },
            ]
        },
        {
            title: "WEBSITE",
    ...
    const socialIcons = [
        { icon: FacebookIcon, link: "https://www.facebook.com/cravesmartaccessories" },
        { icon: InstagramIcon, link: "https://www.instagram.com/cravephoneaccessories" },
        { icon: TikTokIcon, link: "https://www.tiktok.com/@craveaccess1121" },
    ]
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-orange-600">Crave</span>Store<span className="text-orange-600 text-5xl leading-0">.</span>
                        </Link>
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to CraveStore, your ultimate destination for mobile accessories. From phone cases and chargers to earphones and screen protectors, we bring you the best in quality and style — all in one place.</p>
                        <p className="mt-2 text-sm font-semibold text-slate-700">Where innovation meet elegance</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © CraveStore All Rights Reserved.
                </p>
            </div>
        </footer>
    );
